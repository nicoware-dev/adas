...
export const poolInfoAction: Action = {
    ...
    examples: [[
        {
            user: 'user',
            content: { text: "Show me details about the APT/USDC pool" }
        }
    ], [
        {
            user: 'user',
            content: { text: "What's the TVL of the APT/USDT pool?" }
        }
    ], [
        {
            user: 'user',
            content: { text: "Tell me about the amAPT/APT pool" }
        }
    ], [
        {
            user: 'user',
            content: { text: "Show stats for the USDC/APT pool" }
        }
    ]]
};
