...
export const tokenInfoAction: Action = {
    ...
    examples: [[
        {
            user: 'user',
            content: { text: "Show me information about APT token" }
        }
    ], [
        {
            user: 'user',
            content: { text: "What's the market cap of USDC on Aptos?" }
        }
    ], [
        {
            user: 'user',
            content: { text: "Tell me about the amAPT token" }
        }
    ], [
        {
            user: 'user',
            content: { text: "Show stats for the THL token" }
        }
    ]]
};
