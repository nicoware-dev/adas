    ...
    return (
        <TooltipProvider>
            <div className="flex flex-col w-full h-[calc(100vh-115px)]">
                                                ...
                                                <div className="prose prose-invert prose-sm max-w-none">
                                                    <ReactMarkdown
                                                        ...
                                                        components={{
                                                            ...
                                                            a: ({node, ...props}) => <a className="text-[#01C0C9] hover:underline cursor-pointer" {...props} />,
                                                            ...
                                                            blockquote: ({node, ...props}) => <blockquote className="border-l-2 border-[#01C0C9] pl-4 my-2 italic" {...props} />,
                                                            table: ({node, ...props}) => <div className="overflow-x-auto my-2"><table className="min-w-full divide-y divide-[#27353A]" {...props} /></div>,
                                ...
                                <div className="h-[calc(100vh-200px)] flex flex-col items-center justify-center">
                                    ...
                                    {agent && (
                                        <div className="w-full">
                                            <h3 className="text-center text-xl font-semibold mb-2 text-[#01C0C9]">Example Prompts</h3>
                ...
                {/* Input form */}
                <div className="fixed bottom-0 left-0 right-0 border-t border-[#27353A] bg-[#121B1B]/80 backdrop-blur-sm z-10">
                            ...
                            <div className="flex items-end gap-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button
                                        ...
                                        className="h-12 gap-1.5 bg-[#01C0C9] text-white hover:bg-[#01C0C9]/90"
                                    >
